                  ...
                  <div className="col-4 col-md-4 container">
                    {
                      shelfCurrentLoan.book?.img ?
                        <img src={shelfCurrentLoan.book?.img} width='226' height='349' alt="Book"></img>
                        :
                        <img src={require('./../../../Images/BooksImages/book-luv2code-1000.png')}
                          width='226' height='349' alt="Book"></img>
                    }
                  </div>
                      ...
                      <div className="mt-3">
                        ...
                        {shelfCurrentLoan.daysLeft > 0 &&
                          <p className="text-secondary">
                            Due in {shelfCurrentLoan.daysLeft} days.</p>}
                        ...
                        {shelfCurrentLoan.daysLeft < 0 &&
                          <p className="text-danger">
                            Past due by {shelfCurrentLoan.daysLeft} days.</p>
