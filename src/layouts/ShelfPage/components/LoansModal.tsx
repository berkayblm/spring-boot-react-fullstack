              ...
              <div className="mt-3">
                <div className="row">
                  <div className="col-2">
                    {props.shelfCurrentLoan.book?.img ?
                      <img src={props.shelfCurrentLoan.book?.img} width='56' height='87' alt="Book"></img>
                      :
                      <img src={require('./../../../Images/BooksImages/book-luv2code-1000.png')}
                        width='56' height='87' alt="Book"></img>
                    }
                  </div>
                ...
                {props.shelfCurrentLoan.daysLeft > 0 &&
                  <p className="text-secondary">
                    Due in {props.shelfCurrentLoan.daysLeft} days.</p>}
                ...
                {props.shelfCurrentLoan.daysLeft < 0 &&
                  <p className="text-danger">
                    Past due by {props.shelfCurrentLoan.daysLeft} days.</p>
                }
