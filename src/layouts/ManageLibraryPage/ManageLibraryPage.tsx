    ...
    <div className="container">
      <div className="mt-5">
        ...
        <nav>
          <div className="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button onClick = {messagesClickFunction} className="nav-link " id="nav-messages-tab" data-bs-toggle="tab"
              data-bs-target="#nav-messages" type="button" role="tab" aria-controls="nav-messasges"
              aria-selected="false">
              Messages
            </button>
          </div>
        ...
        <div className="tab-content" id="nav-tabContent">
          ...
          <div className="tab-pane fade" id="nav-messages" role="tab-panel" aria-labelledby="nav-messages-tab"
          >
            {messagesClick ? <AdminMessages></AdminMessages> : <></>}
          </div>
        </div>
      </div>
    </div>
